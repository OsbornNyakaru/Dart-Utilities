...
void main() {
  ...
  // Task 2: Print numbers from 1 to 10 using a for loop
  print('Task 2: Print numbers from 1 to 10 using a for loop');
  printNumbers();
  print('');

  // Task 3: Use a switch statement to check different string values
  print('Task 3: Use a switch statement to check different string values');
  checkString('A');
  checkString('B');
  checkString('C');
  print('');
  ...
  // Task 4: Print numbers from 20 to 10 using a while loop
  print('Task 4: Print numbers from 20 to 10 using a while loop');
  printNumbersReverse();
  print('');

  // Task 5: Check if a number is even or odd using an if-else statement
  print('Task 5: Check if a number is even or odd using an if-else statement');
  checkEvenOdd(9);
  checkEvenOdd(10);
  print('');
  ...
  print('Task 6: Takes a list of numbers as input and outputs the largest number on the list');
